...
public class Bow : Range
{
    ...
    void Shoot()
    {
        ...
        dmg.AddDamageAmount((int)(damage * (GameManager.instance.playerAbilities != null? currentCharge + GameManager.instance.playerAbilities.w2DmgMod : currentCharge)));
    ...
    IEnumerator Charge()
    {
        ...
        {
            currentCharge += (GameManager.instance.playerAbilities != null)? chargeRate + GameManager.instance.playerAbilities.w2SpeedMod : chargeRate;
